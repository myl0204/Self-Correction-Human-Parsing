...
# If extensions (or cmodules to document with autodoc) are in another directory,
...
try:
    ...
    for m in [
        ...
        "torch.autograd.function", "torch.nn.cmodules", "torch.nn.cmodules.utils", "torch.utils", "torch.utils.data", "torch.onnx",
